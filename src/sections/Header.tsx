  ...
  return (
    <header className="py-4 border-b border-white/15 md:border-none sticky top-0 z-10">
      ...
      <div className="container">
        <div className="flex  md:border border-white/15  rounded-full max-w-2xl mx-auto relative shadow-[0_10px_20px_rgba(_40,149,_255,_0.6)]">
                ...
                {tabs.map((tab) => (
                  ...
                  >
                    {activeTab === tab.id && (
                      <motion.span
                        layoutId="bubble"
                        className="absolute inset-0 z-10 bg-[rgba(_40,149,_255,_0.7)] dark:mix-blend-screen mix-blend-multiply shadow-[0_4px_10px_rgba(_40,149,_255,_0.6)]"
                          ...
                          return (
                            ...
                            >
                              <a
                                ...
                                className={
                                  "flex items-center justify-between w-full p-5 rounded-xl dark:bg-neutral-950 bg-white"
                                }
                                href={route.href}
                              >
