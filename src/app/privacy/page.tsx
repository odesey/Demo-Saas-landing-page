...
export default function PrivacyPage() {
  ...
  return (
    <div className="">
      <TracingBeam>
        <div className="flex justify-center max-w-2xl mx-auto p-12 md:p-0 md:pt-20 ">
          <div className="flex flex-col gap-7 flex-wrap">
            ...
            <ul className="list-disc pl-5">
              ...
              <li className="my-4">
                <p>
                  <strong>Application</strong> refers to GenesisApp, the
                  software program provided by the Company.
                </p>
              </li>
              <li className="my-4">
                <p>
                  <strong>Business</strong>, for the purpose of CCPA/CPRA,
              ...
              <li className="my-4">
                <p>
                  ...
                  the California Consumer Privacy Act (the &quot;CCPA&quot;) as
              ...
              <li className="my-4">
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to GenesisApp LLC,
                  PO Box 1051 Trion GA 30753.
                </p>
                <p>
              ...
              <li className="my-4">
                <p>
                  ...
                  means a natural person who is a California resident. A
                  resident, as defined in the law, includes (1) every individual
                  who is in the USA for other than a temporary or transitory
                  purpose, and (2) every individual who is domiciled in the USA
            ...
            <ul className="list-disc pl-5">
              <li className="my-4">Comply with a legal obligation</li>
              <li className="my-4">
              ...
              <li className="my-4">Protect against legal liability</li>
            </ul>
            <h3 className="text-xl font-bold">
            ...
            <h2 className="text-2xl font-extrabold">GDPR Privacy</h2>
            <h3 className="text-xl font-bold">
            ...
            <h3 className="text-xl font-bold">Your Rights under the GDPR</h3>
            <p>
            ...
            <h3 className="text-xl font-bold">Use of Personal Information</h3>
            <p>
              We may use or disclose personal information We collect for
              &quot;business purposes&quot; or &quot;commercial purposes&quot;
              (as defined under the CCPA/CPRA), which may include the following
              examples:
            </p>
            <ul className="list-disc pl-5">
              <li className="my-4">
              ...
              <li className="my-4">Other one-time uses.</li>
            </ul>
            <p>
            ...
            <h3 className="text-xl font-bold">Share of Personal Information</h3>
            <p>
            ...
            <h3 className="text-xl font-bold">Sale of Personal Information</h3>
            <p>
            ...
            <ul className="list-disc pl-5">
              <li className="my-4">
                <strong className="font-bold">The right to notice. </strong> You
              ...
              <li className="my-4">
                ...
                information. To submit an opt-out request, please see the
                &quot;Do Not Sell My Personal Information&quot; section or
                contact Us.
              </li>
              <li className="my-4">
                <strong>The right to correct Personal Data.</strong> You have
                the right to correct or rectify any inaccurate personal
                information about You that We collected. Once We receive and
                confirm Your request, We will use commercially reasonable
                efforts to correct (and direct our Service Providers to correct)
              ...
              <li className="my-4">
                ...
                unless an exception applies. To submit, please see the
              ...
              <li className="my-4">
                ...
                <ul className="list-disc pl-5">
                  <li className="my-4">Denying goods or services to You</li>
                  <li className="my-4">
            ...
            <p>
              ...
              use which is necessary to perform the services or provide the
              goods reasonably expected by an average Consumer who requests such
              services or goods.
            </p>
            <p>
            ...
            <h2 className="text-2xl font-extrabold">Children's Privacy</h2>
            <p>
            ...
            <h2 className="text-2xl font-extrabold">Links to Other Websites</h2>
            <p>
